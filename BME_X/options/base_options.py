...
class BaseOptions():
    ...
    #    self.parser.add_argument('--dataroot', required=True, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        self.parser.add_argument('--batchSize', type=int, default=9, help='input batch size')
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='seg', help='chooses how datasets are loaded. [unaligned | aligned | single]')
        self.parser.add_argument('--model', type=str, default='seg',
        ...
        self.parser.add_argument('--downsampling_rate', type=int, default=1, help='downsample training image by this factor')
        self.parser.add_argument('--patchSize', type=int, default=32, help='then crop training image to this size')
        self.parser.add_argument('--normValue', type=float, default=1.0, help='then normalize training image to [-normValue,normValue]')
